...
public class CrawlerSpecification implements Serializable {
	...
	@JsonView({BaseEntity.EditView.class})
	private List<CrawlerSpecification.Entry> entries = new ArrayList<>();
	 ...
	 * @return 条目
	 */
	public List<CrawlerSpecification.Entry> getEntries() {
		return entries;
	}
	 ...
	 *            条目
	 */
	public void setEntries(List<CrawlerSpecification.Entry> entries) {
	 ...
	 */
	@Converter
	public static class SpecificationEntityConverter extends BaseAttributeConverter<List<CrawlerSpecification.Entry>> {
	}
