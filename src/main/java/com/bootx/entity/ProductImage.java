...
public class ProductImage implements Serializable, Comparable<ProductImage> {
	...
	public ProductImage(@NotEmpty @Length(max = 200) String source, @NotEmpty @Length(max = 200) String large, @NotEmpty @Length(max = 200) String medium, @NotEmpty @Length(max = 200) String thumbnail, @Min(0) Integer order) {
		this.source = source;
		this.large = large;
		this.medium = medium;
